<template>
  <div>
    ...
    <div>
        ...
        <p class="card-text"><strong> Por favor </strong> ingresa tus datos de facturación </p>
      </div>
      <br>
   <div>
    ...
    <router-link to="/userformcont">
        <b-button type="submit" variant="primary">Guardar y continuar  </b-button >
    </router-link>  
